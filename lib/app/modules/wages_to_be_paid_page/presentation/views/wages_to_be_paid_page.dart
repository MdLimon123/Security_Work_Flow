...
import 'package:securiverse_security_workforce/app/modules/wages_to_be_paid_page/presentation/controllers/wages_to_be_paid_page_controller.dart';
...
class WagesToBePaidPage extends StatelessWidget {
  ...
  SizedBox _buildSaveAndUpdateButton() {
    return SizedBox(
      ...
      child: GetBuilder<WagesToBePaidPageController>(
        builder: (controller) {
          return ElevatedButton(
            onPressed: () async {
              await controller.updateBankDetails();
            },
